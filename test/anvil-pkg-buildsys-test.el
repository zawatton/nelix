;;; anvil-pkg-buildsys-test.el --- ERT tests for new DSL build systems -*- lexical-binding: t; -*-
...
(ert-deftest anvil-pkg-buildsys-test-render-node ()
...
(ert-deftest anvil-pkg-buildsys-test-render-haskell ()
...
(ert-deftest anvil-pkg-buildsys-test-node-requires-npm-deps-hash ()
...
(provide 'anvil-pkg-buildsys-test)
;;; anvil-pkg-buildsys-test.el ends here
