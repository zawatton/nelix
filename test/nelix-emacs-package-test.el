...
(ert-deftest nelix-emacs-package-transitive-dep-recipes ()
  "Key native recipes carry the transitive dependencies from Doc 33/W3."
  (let ((nelix-registry--packages (make-hash-table :test 'equal)))
    (nelix-registry-load-root (nelix-emacs-package-test--registry-root))
    (dolist (spec '(("shrink-path" . ("s" "dash" "f"))
