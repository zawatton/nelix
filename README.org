...
=nelix-registry-roots= at another directory, or — once one is published
— subscribe to a remote index through =nelix-registry-remotes=, which
hash- and signature-verifies what it fetches.
