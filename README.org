...
*Phase 1+2+3+4-A+4-B+4-C+4-D+4-E SHIPPED + REAL-NIX VERIFIED* (2026-05-06) —
...
- ERT 84/84 PASS (mocked, runs without a nix binary).
...
#+begin_src shell
make test       # 84 ERT tests, no nix binary required (all mocked)
