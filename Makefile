...
TEST_SRC = test/nelix-core-test.el test/nelix-core-uninstall-test.el test/nelix-core-upgrade-test.el test/nelix-core-pin-test.el test/nelix-core-info-test.el test/nelix-core-doctor-test.el test/nelix-dsl-test.el test/nelix-core-buildsys-test.el test/nelix-import-test.el test/nelix-compat-test.el test/nelix-emacs-test.el test/nelix-state-test.el test/nelix-manifest-test.el test/nelix-store-test.el test/nelix-cli-test.el test/nelix-emacs-package-test.el test/nelix-build-test.el test/nelix-backend-system-nixfree-test.el test/nelix-emacs-activate-test.el test/nelix-builder-unpack-test.el test/nelix-builder-builtin-dep-test.el test/nelix-builder-input-test.el test/nelix-fetch-cache-test.el
