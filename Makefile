...
TEST_SRC = test/anvil-pkg-test.el test/anvil-pkg-uninstall-test.el test/anvil-pkg-upgrade-test.el test/anvil-pkg-pin-test.el test/anvil-pkg-info-test.el test/anvil-pkg-dsl-test.el test/anvil-pkg-buildsys-test.el test/anvil-pkg-import-test.el test/anvil-pkg-compat-test.el test/anvil-pkg-emacs-test.el test/anvil-pkg-state-test.el
