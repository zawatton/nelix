...
verify-deb-contents:
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-aot-native-cli-proof.el | grep -Fq '204 target-id rows'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-cli.el | grep -Fq 'transaction recover ID|FILE --dry-run'
