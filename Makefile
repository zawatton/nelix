...
verify-deb-contents:
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq 'NELIX_USER_MANIFEST_MIN_TARGETS'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq 'nelix installed Debian target-count:'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq 'report_top_level_count list'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq 'report_json_counts plan'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq 'report_json_counts apply-dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq 'report_json_counts upgrade-plan'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq -- '--runtime nelisp aot-cache "$$NELIX_USER_MANIFEST"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq -- '--runtime nelisp --json list'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq -- '--runtime nelisp --json audit "$$NELIX_USER_MANIFEST"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq -- '--runtime nelisp --json plan "$$NELIX_USER_MANIFEST" --dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq -- '--runtime nelisp --json apply "$$NELIX_USER_MANIFEST" --dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-debian.sh | grep -Fq -- '--runtime nelisp --json upgrade-plan "$$NELIX_USER_MANIFEST"'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-manifest-dsl.sh | grep -Fq 'timing-$$label-ms'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-manifest-dsl.sh | grep -Fq 'target-count=$$target_count'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-manifest-dsl.sh | grep -Fq 'runtime-status=ok'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-manifest-dsl.sh | grep -Fq 'report_json_counts apply-dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-manifest-dsl.sh | grep -Fq 'report_json_counts upgrade-plan'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'compare_init_json init-plan-apply-dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'NELIX_INIT_MIGRATION_MAX_MISSING'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'NELIX_INIT_MIGRATION_MAX_EXTRA'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'NELIX_INIT_MIGRATION_MAX_REMOVE'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'NELIX_INIT_MIGRATION_NELISP_MAX_SECONDS'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'NELIX_INIT_MIGRATION_MIN_TARGETS'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'nelix init migration timing:'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'nelix init migration target-count:'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'report_top_level_count list'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'report_json_counts plan'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'report_json_counts apply-dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'report_json_counts upgrade-plan'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'check_json_array_limit audit-missing'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'check_json_array_limit audit-extra'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'NELIX_INIT_MIGRATION_REQUIRE_DEB'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq '0|false|no|skip)'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-user-init-migration.sh | grep -Fq 'resolved_nelix_bin'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/schema/nelix-manifest-dsl-v1.schema.json | grep -Fq '"const": ['
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/schema/nelix-manifest-dsl-v1.schema.json | grep -Fq '"form": "emacs-packages"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/schema/nelix-manifest-dsl-v1.schema.json | grep -Fq '"manifest-key": "emacs"'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/schema/nelix-lock-v2.schema.json | grep -Fq '"nix-package-required"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/schema/nelix-lock-v2.schema.json | grep -Fq '"attr-path"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/schema/nelix-lock-v2.schema.json | grep -Fq '"native-package-required"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/schema/nelix-lock-v2.schema.json | grep -Fq '"recipe-install"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'missing nix schema-required key :attr-path'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'invalid source registry for nix backend'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-native-cli-gate.sh | grep -Fq 'missing native schema-required key :recipe-install'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-native-cli-gate.sh | grep -Fq 'invalid source nixpkgs for native backend'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/schema/nelix-transaction-v1.schema.json | grep -Fq '"const": ['
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/schema/nelix-transaction-v1.schema.json | grep -Fq '"before-generation"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/schema/nelix-transaction-v1.schema.json | grep -Fq '"rollback-plan-available-required"'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq 'nelix extracted Debian target-count:'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq 'report_top_level_count list'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq 'report_json_counts plan'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq 'report_json_counts apply-dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq 'report_json_counts upgrade-plan'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq -- 'run_extracted_nelix --runtime nelisp aot-cache "$$NELIX_USER_MANIFEST"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq -- 'run_extracted_nelix --runtime nelisp --json list'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq -- 'run_extracted_nelix --runtime nelisp --json audit "$$NELIX_USER_MANIFEST"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq -- 'run_extracted_nelix --runtime nelisp --json plan "$$NELIX_USER_MANIFEST" --dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq -- 'run_extracted_nelix --runtime nelisp --json apply "$$NELIX_USER_MANIFEST" --dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq -- 'run_extracted_nelix --runtime nelisp --json upgrade-plan "$$NELIX_USER_MANIFEST"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-extracted-nelix-debian.sh | grep -Fq -- 'run_extracted_nelix --runtime nelisp --json lock-check "$$NELIX_USER_MANIFEST"'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/bin/nelix | grep -q 'nelix_run_aot_apply_shell_lane'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/bin/nelix | grep -q 'apply-real-locked'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -tf - | grep -q './usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-aot-native-subset.el'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-aot-native-cli-proof.el | grep -Fq '(defun nelix-aot-native-cli-large-id-scan-proof'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-aot-native-cli-proof.el | grep -Fq '(defun nelix-aot-native-cli-large-id-summary-proof'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-aot-native-cli-proof.el | grep -Fq '768 target-id rows'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-aot-native-cli-proof.el | grep -Fq 'payload-threshold'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-cli.el | grep -Fq 'lock validate MANIFEST'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-cli.el | grep -Fq 'lock diff MANIFEST'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-cli.el | grep -Fq 'lock migrate MANIFEST [--dry-run]'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-cli.el | grep -Fq 'lock-check MANIFEST'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-cli.el | grep -Fq 'transaction list [--limit N]'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-cli.el | grep -Fq 'transaction show ID|FILE'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-cli.el | grep -Fq 'transaction recover ID|FILE (--dry-run|--execute)'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/emacs/site-lisp/elpa-src/nelix-0.1.0/nelix-cli.el | grep -Fq 'schema [manifest-dsl-v1|lock-v2|transaction-v1|all]'
...
# count, not a name, so adding or renaming one recipe does not edit this gate.
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-native-cli-gate.sh | grep -Fq 'native lock omitted recipe source metadata'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-native-cli-gate.sh | grep -Fq 'native lock omitted app source hash'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-nelix-native-cli-gate.sh | grep -Fq 'mvp_checkpoint recipe-registry'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'dsl_plan plan "$$dsl_manifest" --dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '(require '\''nelix-dsl)'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'raw_private_validate none validate'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'dsl_private_form_validate none validate'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'dsl_private_option_validate none validate'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'private data option :secret'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'private data option :private-repo'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'lock_validate lock validate'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'lock_diff lock diff'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'lock_migrate_dry_run lock migrate'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'lock_migrate_legacy_dry_run lock migrate'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'lock_migrate_legacy_write lock migrate'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '"from-schema-version":1'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '"written-schema-version":2'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'assert_lock_fingerprint_unchanged lock_validate'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'assert_lock_fingerprint_unchanged lock_diff'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'assert_lock_fingerprint_unchanged lock_migrate_dry_run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'validate_lock_json_schema_smoke'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'validate_schema_summary_contract schema_lock'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'bad_lock_validate lock validate'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'lock package row 1 is missing schema-required key :source'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'bad_lock_apply_locked __never__'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'assert_transaction_record_count bad-lock-apply-locked'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'validate_plan_apply_dry_run_equivalence'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'assert_transaction_record_count apply-dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'assert_transaction_record_count locked-apply-dry-run'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'nelix-manifest-dsl-v1.schema.json'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '"forbidden-forms":\['
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '"private-repo"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '"private-data":"forbidden"'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'run_failing_json failed_apply fd apply'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'run_failing_json no_rollback_failed_apply fd apply'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'run_failing_json transaction_recover_no_rollback fd transaction'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '"reason":"rollback-disabled"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'rollback unavailable'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '"record-status":"error"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'profile rollback --profile '
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'locked apply rewrote lock file'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'transaction_show_ok transaction show "$$ok_record"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '"record-status":"ok"'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '"action":"install","name":"fd"'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'transaction_recover_error transaction recover "$$failed_record" --dry-run'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'transaction_recover_execute transaction recover "$$failed_record" --execute'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq 'transaction_recover_ok_execute'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/verify-installed-nelix-cli-gate.sh | grep -Fq '"recovery":"nelix transaction recover ID|FILE (--dry-run|--execute)"'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/README.org.gz | gzip -dc | grep -q 'make verify-user-source-gate'
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/README.org.gz | gzip -dc | grep -q 'make verify-source-operational-gate'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/README.org.gz | gzip -dc | grep -q 'make verify-installed-operational-gate'
	...
	dpkg-deb --fsys-tarfile "$(DEB)" | tar -xO ./usr/share/doc/elpa-nelix/packaging/README.org.gz | gzip -dc | grep -q 'make verify-user-init-migration-load'
...
verify-user-runtime-gate:
	NELIX_BIN="$${NELIX_BIN:-$(CURDIR)/bin/nelix}" \
	NELIX_LISPDIR="$${NELIX_LISPDIR:-$(CURDIR)}" \
	NELIX_USER_MANIFEST="$${NELIX_USER_MANIFEST:-$(HOME)/.emacs.d/nelix-package.el}" \
	NELIX_USER_MANIFEST_LABEL="$${NELIX_USER_MANIFEST_LABEL:-source-runtime}" \
	...
	NELIX_USER_MANIFEST_MIN_TARGETS="$${NELIX_USER_MANIFEST_MIN_TARGETS:-180}" \
...
verify-user-init-migration-load:
	NELIX_BIN="$${NELIX_BIN:-$(CURDIR)/bin/nelix}" \
	NELIX_LISPDIR="$${NELIX_LISPDIR:-$(CURDIR)}" \
	NELIX_INIT_MIGRATION_REQUIRE_DEB="$${NELIX_INIT_MIGRATION_REQUIRE_DEB:-skip}" \
	NELIX_INIT_MIGRATION_AUDIT="$${NELIX_INIT_MIGRATION_AUDIT:-load-only}" \
	NELIX_INIT_MIGRATION_MIN_TARGETS="$${NELIX_INIT_MIGRATION_MIN_TARGETS:-180}" \
	NELIX_INIT_MIGRATION_MAX_MISSING="$${NELIX_INIT_MIGRATION_MAX_MISSING:-0}" \
	NELIX_INIT_MIGRATION_MAX_EXTRA="$${NELIX_INIT_MIGRATION_MAX_EXTRA:-0}" \
	NELIX_INIT_MIGRATION_MAX_REMOVE="$${NELIX_INIT_MIGRATION_MAX_REMOVE:-0}" \
	NELIX_INIT_MIGRATION_NELISP_MAX_SECONDS="$${NELIX_INIT_MIGRATION_NELISP_MAX_SECONDS:-20}" \
	packaging/verify-nelix-user-init-migration.sh
...
help:
	...
	@echo "make smoke-nelix-aot-native-cli-proof — verify public standalone .neln native CLI proof"
	...
	@echo "make verify-user-runtime-gate — strict source-tree NeLisp gate for ~/.emacs.d/nelix-package.el"
	@echo "make verify-user-source-gate — run source-tree real manifest + init load gates"
	@echo "make verify-source-operational-gate — run source-tree manifest, transaction, lock, and native gates"
	...
	@echo "make verify-installed-operational-gate — run installed CLI and real manifest runtime gates"
	...
	@echo "make verify-user-init-migration-load — source-tree init migration load-only gate"
...
#
# Publishes registry/ as a subscribable index: index.el plus the recipe files
# it names, both content-addressed.  A subscriber pins the index hash, the
# index pins every recipe hash, so neither can be swapped after the fact.
#
# No signing yet.  Unsigned still detects tampering -- a changed byte fails
# its hash -- but it means a subscriber must update the pinned index hash to
# receive a new index.  Signing is what removes that step; see
# nelix-registry-require-signature.
PAGES_DIR ?= public

registry-index:
	$(EMACS_BATCH) -L . --eval '(progn (require (quote nelix-registry)) (princ (format "%S\n" (nelix-registry-write-index "registry" "$(PAGES_DIR)/index.el"))))'
...
# Round-trips the published tree through a subscriber with an empty cache and
# no packaged recipes, so the count proves the recipes came from the index.
smoke-registry-pages: pages
	tools/nelix-registry-pages-gate.sh "$(PAGES_DIR)"

smoke-nelix-lock-schema:
...
smoke-native-build:
	@command -v cc >/dev/null 2>&1 || { \
	  echo "error: smoke-native-build: cc not found on PATH (host C compiler required for Tier-0)"; \
	  exit 1; \
	}
	@tmp=$$(mktemp -d); \
	  home="$$tmp/home"; \
	  ...
	  store_root="$$data/nelix/store"; \
	  result_file="$$tmp/result.el"; \
	  recipe_file="$(CURDIR)/test/fixtures/hello-native.el"; \
	  cleanup() { rm -rf "$$tmp"; }; \
	  trap cleanup EXIT HUP INT TERM; \
	  echo "smoke-native-build: building hello-native (trivial C, no Nix)..."; \
	  env HOME="$$home" XDG_DATA_HOME="$$data" XDG_STATE_HOME="$$state" \
	      NELIX_REGISTRY_INCLUDE_PACKAGED=0 \
	    $(EMACS_BATCH) \
	    --eval '(setq load-prefer-newer t)' \
	    --eval "(require 'nelix-builder)" \
	    --eval "(require 'nelix-registry)" \
	    --eval "(nelix-registry--load-file \"$$recipe_file\")" \
	    --eval "(let* ((recipe (nelix-registry-get \"hello-native\")) \
	                   (report (nelix-native-install-recipe recipe \"default\" (quote x86_64-linux)))) \
	              (with-temp-file \"$$result_file\" \
	                (prin1 report (current-buffer))) \
	              (message \"install-report: %S\" report))" \
	    2>&1 || { echo "error: smoke-native-build: emacs install step failed"; exit 1; }; \
	  \
	  store_bin=$$(find "$$store_root" -name hello -type f 2>/dev/null | head -1); \
	  test -n "$$store_bin" || { \
	    echo "error: smoke-native-build: hello binary not found in store $$store_root"; \
	    exit 1; \
	  }; \
	  echo "smoke-native-build: binary found in store: $$store_bin"; \
	  out=$$("$$store_bin"); \
	  test "$$out" = "nelix-native-build-ok" || { \
	    echo "error: smoke-native-build: binary output was '$$out', expected 'nelix-native-build-ok'"; \
	    exit 1; \
	  }; \
	  echo "smoke-native-build: binary ran from store and printed: $$out"; \
	  echo "smoke-native-build: SUCCESS — C program source-built and verified with no nix on PATH"

smoke-native-build-elisp:
	@command -v cc >/dev/null 2>&1 || { echo "error: smoke-native-build-elisp: cc not found"; exit 1; }
	@tmp=$$(mktemp -d); \
	  home="$$tmp/home"; data="$$tmp/data"; state="$$tmp/state"; mkdir -p "$$home" "$$data" "$$state"; \
	  store_root="$$data/nelix/store"; recipe="$(CURDIR)/test/fixtures/hello-elisp.el"; \
	  cleanup() { rm -rf "$$tmp"; }; trap cleanup EXIT HUP INT TERM; \
	  echo "smoke-native-build-elisp: building hello-elisp (Lisp-native phases, NO shell strings, no Nix)..."; \
	  env HOME="$$home" XDG_DATA_HOME="$$data" XDG_STATE_HOME="$$state" NELIX_REGISTRY_INCLUDE_PACKAGED=0 \
	    $(EMACS_BATCH) --eval '(setq load-prefer-newer t)' \
	      --eval "(require 'nelix-builder)" --eval "(require 'nelix-registry)" \
	      --eval "(nelix-registry--load-file \"$$recipe\")" \
	      --eval "(nelix-native-install-recipe (nelix-registry-get \"hello-elisp\") \"default\" (quote x86_64-linux))" \
	    2>&1 || { echo "error: smoke-native-build-elisp: install step failed"; exit 1; }; \
	  store_bin=$$(find "$$store_root" -name hello -type f 2>/dev/null | head -1); \
	  test -n "$$store_bin" || { echo "error: smoke-native-build-elisp: binary not in store"; exit 1; }; \
	  env -i PATH=/usr/bin:/bin "$$store_bin"; rc=$$?; \
	  test "$$rc" -eq 42 || { echo "error: smoke-native-build-elisp: exit $$rc, expected 42 (Lisp-native substitute* must patch 7->42)"; exit 1; }; \
	  echo "smoke-native-build-elisp: binary exit $$rc (expected 42 — nelix-substitute*/invoke/install-file ran as Elisp)"; \
	  echo "smoke-native-build-elisp: SUCCESS — Lisp-native build phases (no shell strings) built+ran, no nix"

smoke-native-build-make:
	@command -v cc >/dev/null 2>&1 || { \
	  echo "error: smoke-native-build-make: cc not found on PATH (host C compiler required)"; \
	  exit 1; \
	}
	@command -v make >/dev/null 2>&1 || { \
	  echo "error: smoke-native-build-make: make not found on PATH"; \
	  exit 1; \
	}
	@tmp=$$(mktemp -d); \
	  home="$$tmp/home"; \
	  ...
	  store_root="$$data/nelix/store"; \
	  result_file="$$tmp/result.el"; \
	  recipe_file="$(CURDIR)/test/fixtures/hello-native-make.el"; \
	  cleanup() { rm -rf "$$tmp"; }; \
	  trap cleanup EXIT HUP INT TERM; \
	  echo "smoke-native-build-make: building hello-native-make (make preset, no Nix)..."; \
	  env HOME="$$home" XDG_DATA_HOME="$$data" XDG_STATE_HOME="$$state" \
	      NELIX_REGISTRY_INCLUDE_PACKAGED=0 \
	    $(EMACS_BATCH) \
	    --eval '(setq load-prefer-newer t)' \
	    ...
	    --eval "(require 'nelix-registry)" \
	    --eval "(nelix-registry--load-file \"$$recipe_file\")" \
	    --eval "(let* ((recipe (nelix-registry-get \"hello-native-make\")) \
	                   (report (nelix-native-install-recipe recipe \"default\" (quote x86_64-linux)))) \
	              (with-temp-file \"$$result_file\" \
	                (prin1 report (current-buffer))) \
	              (message \"install-report: %S\" report))" \
	    2>&1 || { echo "error: smoke-native-build-make: emacs install step failed"; exit 1; }; \
	  \
	  store_bin=$$(find "$$store_root" -name hello-make -type f 2>/dev/null | head -1); \
	  test -n "$$store_bin" || { \
	    echo "error: smoke-native-build-make: hello-make binary not found in store $$store_root"; \
	    exit 1; \
	  }; \
	  echo "smoke-native-build-make: binary found in store: $$store_bin"; \
	  out=$$(env -i PATH=/usr/bin:/bin "$$store_bin"); \
	  test "$$out" = "nelix-native-make-build-ok" || { \
	    echo "error: smoke-native-build-make: binary output was '$$out', expected 'nelix-native-make-build-ok'"; \
	    exit 1; \
	  }; \
	  echo "smoke-native-build-make: binary ran from store and printed: $$out"; \
	  echo "smoke-native-build-make: SUCCESS — C program built via 'make preset and verified with no nix on PATH"

smoke-guix-to-native:
	@command -v cc >/dev/null 2>&1 || { \
	  echo "error: smoke-guix-to-native: cc not found on PATH (host C compiler required)"; \
	  exit 1; \
	}
	@test -f "$(LDB_REPO)/ldb-guix-importer.el" || { \
	  echo "error: smoke-guix-to-native: lisp-dialect-bridge not at $(LDB_REPO) (set LDB_REPO)"; \
	  exit 1; \
	}
	@tmp=$$(mktemp -d); \
	  home="$$tmp/home"; data="$$tmp/data"; state="$$tmp/state"; \
	  mkdir -p "$$home" "$$data" "$$state"; \
	  store_root="$$data/nelix/store"; \
	  recipe="$(CURDIR)/test/fixtures/hello-guix.scm"; \
	  cleanup() { rm -rf "$$tmp"; }; trap cleanup EXIT HUP INT TERM; \
	  echo "smoke-guix-to-native: Guix recipe -> ldb -> nelix executor (no Nix)..."; \
	  env HOME="$$home" XDG_DATA_HOME="$$data" XDG_STATE_HOME="$$state" \
	      NELIX_REGISTRY_INCLUDE_PACKAGED=0 GUIX_RECIPE="$$recipe" \
	    $(EMACS_BATCH) -L "$(LDB_REPO)" \
	      --eval '(setq load-prefer-newer t)' \
	      -l test/fixtures/guix-to-native-driver.el \
	    2>&1 || { echo "error: smoke-guix-to-native: import/install step failed"; exit 1; }; \
	  store_bin=$$(find "$$store_root" -name hello-guix -type f 2>/dev/null | head -1); \
	  test -n "$$store_bin" || { \
	    echo "error: smoke-guix-to-native: hello-guix binary not found in $$store_root"; \
	    exit 1; \
	  }; \
	  echo "smoke-guix-to-native: binary found in store: $$store_bin"; \
	  env -i PATH=/usr/bin:/bin "$$store_bin"; rc=$$?; \
	  test "$$rc" -eq 42 || { \
	    echo "error: smoke-guix-to-native: binary exit was $$rc, expected 42"; \
	    exit 1; \
	  }; \
	  echo "smoke-guix-to-native: binary ran from store with exit code $$rc (expected 42)"; \
	  echo "smoke-guix-to-native: SUCCESS — Guix recipe built from source via ldb+nelix, no nix on PATH"

smoke-guix-to-native-rich:
	@command -v cc >/dev/null 2>&1 || { echo "error: smoke-guix-to-native-rich: cc not found"; exit 1; }
	@test -f "$(LDB_REPO)/ldb-guix-importer.el" || { echo "error: lisp-dialect-bridge not at $(LDB_REPO)"; exit 1; }
	@tmp=$$(mktemp -d); \
	  home="$$tmp/home"; data="$$tmp/data"; state="$$tmp/state"; \
	  mkdir -p "$$home" "$$data" "$$state"; \
	  store_root="$$data/nelix/store"; \
	  recipe="$(CURDIR)/test/fixtures/hello-guix-rich.scm"; \
	  cleanup() { rm -rf "$$tmp"; }; trap cleanup EXIT HUP INT TERM; \
	  echo "smoke-guix-to-native-rich: Guix recipe (substitute*/install-file/string-append) -> ldb -> nelix (no Nix)..."; \
	  env HOME="$$home" XDG_DATA_HOME="$$data" XDG_STATE_HOME="$$state" \
	      NELIX_REGISTRY_INCLUDE_PACKAGED=0 GUIX_RECIPE="$$recipe" \
	    $(EMACS_BATCH) -L "$(LDB_REPO)" \
	      --eval '(setq load-prefer-newer t)' \
	      -l test/fixtures/guix-to-native-driver.el \
	    2>&1 || { echo "error: smoke-guix-to-native-rich: import/install failed"; exit 1; }; \
	  store_bin=$$(find "$$store_root" -name hello-guix -type f 2>/dev/null | head -1); \
	  test -n "$$store_bin" || { echo "error: smoke-guix-to-native-rich: binary not in store (install-file/$$out expansion?)"; exit 1; }; \
	  env -i PATH=/usr/bin:/bin "$$store_bin"; rc=$$?; \
	  test "$$rc" -eq 42 || { echo "error: smoke-guix-to-native-rich: exit was $$rc, expected 42 (substitute* must patch 7->42 before build)"; exit 1; }; \
	  echo "smoke-guix-to-native-rich: binary exit $$rc (expected 42 — substitute*+install-file+string-append+assoc-ref all ran)"; \
	  echo "smoke-guix-to-native-rich: SUCCESS — broadened Guix phase ops built+ran via ldb+nelix, no nix"

smoke-deps-inputs:
	@command -v cc >/dev/null 2>&1 || { \
	  echo "error: smoke-deps-inputs: cc not found on PATH (host C compiler required)"; \
	  exit 1; \
	}
	@tmp=$$(mktemp -d); \
	  home="$$tmp/home"; data="$$tmp/data"; state="$$tmp/state"; \
	  ...
	  store_root="$$data/nelix/store"; \
	  cleanup() { rm -rf "$$tmp"; }; trap cleanup EXIT HUP INT TERM; \
	  echo "smoke-deps-inputs: building useapp (depends on libgreet) — tests (nelix-input ...) store-path injection..."; \
	  env HOME="$$home" XDG_DATA_HOME="$$data" XDG_STATE_HOME="$$state" \
	      NELIX_REGISTRY_INCLUDE_PACKAGED=0 \
	    $(EMACS_BATCH) \
	    --eval '(setq load-prefer-newer t)' \
	    --eval "(require 'nelix-builder)" \
	    --eval "(require 'nelix-registry)" \
	    --eval "(nelix-registry--load-file \"$(CURDIR)/test/fixtures/libgreet.el\")" \
	    --eval "(nelix-registry--load-file \"$(CURDIR)/test/fixtures/useapp.el\")" \
	    --eval "(let* ((recipe (nelix-registry-get \"useapp\")) \
	                   (report (nelix-native-install-recipe recipe \"default\" (quote x86_64-linux)))) \
	              (message \"install-report: %S\" report))" \
	    2>&1 || { echo "error: smoke-deps-inputs: emacs install step failed"; exit 1; }; \
	  store_bin=$$(find "$$store_root" -name useapp -type f 2>/dev/null | head -1); \
	  test -n "$$store_bin" || { \
	    echo "error: smoke-deps-inputs: useapp binary not found in store $$store_root"; \
	    exit 1; \
	  }; \
	  echo "smoke-deps-inputs: useapp binary found in store: $$store_bin"; \
	  env -i PATH=/usr/bin:/bin "$$store_bin"; rc=$$?; \
	  test "$$rc" -eq 42 || { \
	    echo "error: smoke-deps-inputs: useapp exit $$rc, expected 42 (libgreet value=42 must reach via nelix-input)"; \
	    exit 1; \
	  }; \
	  echo "smoke-deps-inputs: useapp exited $$rc (expected 42 — libgreet built first, its store path injected via nelix-input)"; \
	  echo "smoke-deps-inputs: SUCCESS — multi-package dependency + inputs injection verified, no nix"

smoke-native-build-standalone:
	@test -x "$(NELISP_BIN)" || { echo "smoke-native-build-standalone: SKIP — standalone NeLisp binary not at $(NELISP_BIN) (build it: make -C ../nelisp standalone-reader)"; exit 0; }
	@command -v cc >/dev/null 2>&1 || { echo "error: smoke-native-build-standalone: cc not found"; exit 1; }
	@tmp=$$(mktemp -d); \
	  mkdir -p "$$tmp/h" "$$tmp/d" "$$tmp/s" "$$tmp/bin"; \
	  printf '#!/bin/sh\necho INVOKED >> %s/nixlog\nexit 127\n' "$$tmp" > "$$tmp/bin/nix"; chmod +x "$$tmp/bin/nix"; : > "$$tmp/nixlog"; \
	  cleanup() { rm -rf "$$tmp"; }; trap cleanup EXIT HUP INT TERM; \
	  echo "smoke-native-build-standalone: building hello-native ON the standalone NeLisp binary (no Emacs, nix poisoned)..."; \
	  env -i PATH="$$tmp/bin:/usr/bin:/bin" HOME="$$tmp/h" XDG_DATA_HOME="$$tmp/d" XDG_STATE_HOME="$$tmp/s" \
	    "$(NELISP_BIN)" --load "$(CURDIR)/scripts/nelix-standalone-driver.el" \
	    2>&1 | grep -E "SUCCESS|FATAL|error" || true; \
	  sb=$$(find "$$tmp/d/nelix/store" -name hello -type f 2>/dev/null | head -1); \
	  test -n "$$sb" || { echo "error: smoke-native-build-standalone: binary not built in store"; exit 1; }; \
	  out=$$(env -i PATH=/usr/bin:/bin "$$sb"); \
...
smoke-deps-inputs-standalone:
	@test -x "$(NELISP_BIN)" || { echo "smoke-deps-inputs-standalone: SKIP — standalone NeLisp binary not at $(NELISP_BIN)"; exit 0; }
	@command -v cc >/dev/null 2>&1 || { echo "error: smoke-deps-inputs-standalone: cc not found"; exit 1; }
	@tmp=$$(mktemp -d); \
	  mkdir -p "$$tmp/h" "$$tmp/d" "$$tmp/s" "$$tmp/bin"; \
	  printf '#!/bin/sh\necho INVOKED >> %s/nixlog\nexit 127\n' "$$tmp" > "$$tmp/bin/nix"; chmod +x "$$tmp/bin/nix"; : > "$$tmp/nixlog"; \
	  cleanup() { rm -rf "$$tmp"; }; trap cleanup EXIT HUP INT TERM; \
	  echo "smoke-deps-inputs-standalone: building useapp (dep: libgreet) ON standalone NeLisp (no Emacs, nix poisoned)..."; \
	  env -i PATH="$$tmp/bin:/usr/bin:/bin" HOME="$$tmp/h" XDG_DATA_HOME="$$tmp/d" XDG_STATE_HOME="$$tmp/s" \
	    "$(NELISP_BIN)" --load "$(CURDIR)/scripts/nelix-deps-standalone-driver.el" \
	    2>&1 | grep -E "SUCCESS|FATAL|error" || true; \
	  sb=$$(find "$$tmp/d/nelix/store" -name useapp -type f 2>/dev/null | head -1); \
	  test -n "$$sb" || { echo "error: smoke-deps-inputs-standalone: useapp binary not built"; exit 1; }; \
	  lg=$$(find "$$tmp/d/nelix/store" -type d -name "*libgreet*" 2>/dev/null | head -1); \
	  test -n "$$lg" || { echo "error: smoke-deps-inputs-standalone: libgreet not built (dep graph)"; exit 1; }; \
	  env -i PATH=/usr/bin:/bin "$$sb"; rc=$$?; \
	  test "$$rc" -eq 42 || { echo "error: smoke-deps-inputs-standalone: useapp exit $$rc, expected 42"; exit 1; }; \
	  test ! -s "$$tmp/nixlog" || { echo "error: smoke-deps-inputs-standalone: nix WAS invoked"; exit 1; }; \
	  echo "smoke-deps-inputs-standalone: libgreet built first, useapp exit $$rc (expected 42 — nelix-input store-path injection)"; \
	  echo "smoke-deps-inputs-standalone: SUCCESS — dependency graph + inputs injection on standalone NeLisp, NO Emacs, NO nix"

smoke-sandbox-bwrap:
	@command -v bwrap >/dev/null 2>&1 || { echo "smoke-sandbox-bwrap: SKIP — bwrap not installed"; exit 0; }
	@test -x "$(NELISP_BIN)" || { echo "smoke-sandbox-bwrap: SKIP — standalone NeLisp binary not at $(NELISP_BIN)"; exit 0; }
	@command -v cc >/dev/null 2>&1 || { echo "error: smoke-sandbox-bwrap: cc not found"; exit 1; }
	@echo "smoke-sandbox-bwrap: Tier 2 — hello-native built inside a bwrap namespace sandbox (no nix); asserting network denied..."
	@NELISP_BIN="$(NELISP_BIN)" NELIX_REGISTRY_INCLUDE_PACKAGED=0 \
	  $(EMACS_BATCH) \
	    --eval '(setq load-prefer-newer t)' \
	    --load "$(CURDIR)/scripts/nelix-sandbox-smoke.el"

smoke-sandbox-deps:
	@command -v bwrap >/dev/null 2>&1 || { echo "smoke-sandbox-deps: SKIP — bwrap not installed"; exit 0; }
	@test -x "$(NELISP_BIN)" || { echo "smoke-sandbox-deps: SKIP — standalone NeLisp binary not at $(NELISP_BIN)"; exit 0; }
	@command -v cc >/dev/null 2>&1 || { echo "error: smoke-sandbox-deps: cc not found"; exit 1; }
	@echo "smoke-sandbox-deps: Tier 2/T1 — useapp (dep: libgreet) built inside bwrap sandboxes, (nelix-input) bound RO..."
	@NELISP_BIN="$(NELISP_BIN)" NELIX_REGISTRY_INCLUDE_PACKAGED=0 \
	  $(EMACS_BATCH) \
	    --eval '(setq load-prefer-newer t)' \
	    --load "$(CURDIR)/scripts/nelix-sandbox-deps-smoke.el"

smoke-sandbox-fod:
	@command -v bwrap >/dev/null 2>&1 || { echo "smoke-sandbox-fod: SKIP — bwrap not installed"; exit 0; }
	@test -x "$(NELISP_BIN)" || { echo "smoke-sandbox-fod: SKIP — standalone NeLisp binary not at $(NELISP_BIN)"; exit 0; }
	@command -v cc >/dev/null 2>&1 || { echo "error: smoke-sandbox-fod: cc not found"; exit 1; }
	@echo "smoke-sandbox-fod: Tier 2/T2 — fixed-output source (host fetch+verify) built OFFLINE in bwrap; wrong hash rejected..."
	@NELISP_BIN="$(NELISP_BIN)" NELIX_REGISTRY_INCLUDE_PACKAGED=0 \
	  $(EMACS_BATCH) \
	    --eval '(setq load-prefer-newer t)' \
	    --load "$(CURDIR)/scripts/nelix-sandbox-fod-smoke.el"

smoke-sandbox-repro:
	@command -v bwrap >/dev/null 2>&1 || { echo "smoke-sandbox-repro: SKIP — bwrap not installed"; exit 0; }
	@test -x "$(NELISP_BIN)" || { echo "smoke-sandbox-repro: SKIP — standalone NeLisp binary not at $(NELISP_BIN)"; exit 0; }
	@command -v cc >/dev/null 2>&1 || { echo "error: smoke-sandbox-repro: cc not found"; exit 1; }
	@echo "smoke-sandbox-repro: Tier 2/T3 — two sandbox builds byte-identical + toolchain-input RO bind..."
	@NELISP_BIN="$(NELISP_BIN)" NELIX_REGISTRY_INCLUDE_PACKAGED=0 \
	  $(EMACS_BATCH) \
	    --eval '(setq load-prefer-newer t)' \
	    --load "$(CURDIR)/scripts/nelix-sandbox-repro-smoke.el"

smoke-sandbox-rawns:
	@test -x "$(NELISP_BIN)" || { echo "smoke-sandbox-rawns: SKIP — standalone NeLisp binary not at $(NELISP_BIN)"; exit 0; }
	@command -v cc >/dev/null 2>&1 || { echo "error: smoke-sandbox-rawns: cc not found"; exit 1; }
	@echo "smoke-sandbox-rawns: Tier 2/T4 — PURE-ELISP raw-ns backend (no bwrap): build in namespaces, network denied..."
	@NELISP_BIN="$(NELISP_BIN)" NELIX_REGISTRY_INCLUDE_PACKAGED=0 \
	  $(EMACS_BATCH) \
	    --eval '(setq load-prefer-newer t)' \
	    --load "$(CURDIR)/scripts/nelix-sandbox-rawns-smoke.el"
